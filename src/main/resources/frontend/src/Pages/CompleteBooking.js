      ...
      <div className="white">
        <div className="justify-content-center">
          ...
          <h5 className="thankYouText mt-4 mb-4" align="center">
            Thank you for booking at ClearBNB!
          </h5>

          <div className="confirmBookingText darkbrowntext text-left">
            <b>Residence:</b> {residence.title} <br></br>
            <b>Location:</b> {residence.address.city},{" "}
            {residence.address.country} <br></br>
            <b>Amount of Guests:</b> {numberofguests} <br></br>
            <b>Chosen date:</b> {checkinDate} - {checkoutDate}
            <br></br>
            <br></br>
            <b>Total Price:</b> {residence.pricepernight} x {amountofnights}{" "}
            nights =<b className="priceText golden">${totalprice}</b>
          </div>

          <Button
            className="returnButton col-10 offset-1 mt-5 mb-5"
            onClick={returnHome}
          >
